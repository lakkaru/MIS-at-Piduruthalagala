<div id="pagesBackgorund">
    <div class="row well">
        <form method="post" class="form-horizontal " action="<?php echo URL; ?>notice/editSave/<?php echo $this->notice[0]['noticeId']; ?>">
            <div class="container-fluid">
                <div class="col-lg-6">
                    <legend class="lead">Staff Notice Edit</legend>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6">
                    <textarea id="description" class="form-control" name="description" required><?php echo $this->notice[0]['description'] ?></textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="text-right col-lg-7">
                    <div class="btn">
                        ...
                        <a href="<?php echo URL . 'notice'; ?>" ><span class="glyphicon glyphicon-backward" ></span>&nbsp;Back&nbsp;<span class="glyphicon glyphicon-backward" ></span></a>
                    </div> 
                </div>
            </div>
        </form>
